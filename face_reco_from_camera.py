...
# 处理存放所有人脸特征的 csv
path_features_known_csv = "img/features_all.csv"
...
def cv2ImgAddText(img, text, left, top, textColor=(98, 255, 255), textSize=10):
        ...
        if len(faces) != 0:
            ...
            for k in range(len(faces)):
                ...
                if min(e_distance_list) < 0.4:
                    ...
                    #name_namelist[k] = "SYM "+str(int(similar_person_num)+1)
                    #print("May be person "+str(int(similar_person_num)+1))
                    name_namelist[k] = str("Person " + str(int(similar_person_num) + 1)) \
                        .replace("Person 1", "沈彦明") \
                        .replace("Person 2", "王卓翊") \
                        .replace("Person 3", "赖文智") \
            ...
            for i in range(len(faces)):
                    img_rd = cv2ImgAddText(img_rd,name_namelist[i],pos_namelist[i][0],pos_namelist[i][1],(0, 255, 255),25)
                    #cv2.putText(img_rd, name_namelist[i], pos_namelist[i], font, 0.8, (0, 255, 255), 1, cv2.LINE_AA)
                    #print(pos_namelist[i][0])
                    #print(pos_namelist[i][1])
